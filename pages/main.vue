...
import Comp from '~/components/Editor.vue'

// import Comp from '~/components/Tasklist.vue'
// import Comp from '~/pages/left.vue'
// import Comp from '~/pages/center.vue'
// import Comp from '~/pages/right.vue'
